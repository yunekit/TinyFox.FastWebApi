...
namespace TinyFox.FastWebApi
{
    ...
    class FormHandler
    {
        ...
        public IList<FormItem> FormItems
        {
            get
            {
                if (_dictionary.Count < 1) return new List<FormItem>();
        ...
        public FormItem this[string name]
        {
            get
            {
                if (!_dictionary.Keys.Contains(name)) return null;
        ...
        public FormHandler(IOwinContext context)
        {
            ...
            if (string.IsNullOrEmpty(strLen)) strLen = context.Request.Headers["content-length"];
        ...
        private void ParseMulitPartItem(byte[] body)
        {
            ...
            var strHandles = strHandle.Split(new string[] { "\r\n" }, StringSplitOptions.RemoveEmptyEntries);
